...
export default function EventsPage() {
 ...
 FLAGSHIP EVENTS &amp; <span>HACKATHONS</span>
 </ScrollText>
 ...
 <div className="mb-16 border border-brand-blue-500/30 bg-gradient-to-r from-blue-900/30 via-[#070F2B]/90 to-black p-8 -2xl shadow-brutal flex flex-col md:flex-row items-center justify-between gap-6">
 <div className="space-y-2 text-center md:text-left">
 <span className="font-mono text-xs font-bold text-brand-blue uppercase tracking-widest flex items-center justify-center md:justify-start gap-2">
 <span className="h-2 w-2 bg-brand-blue/10" />
 UPCOMING FLAGSHIP HACKATHON
 </span>
 <h2 className="font-display text-2xl sm:text-4xl font-bold text-brand-blue">
 InnovateIoT National Hackathon &apos;26
 </h2>
 <p className="text-sm font-light text-brand-blue/80">
 ...
 className="shrink-0 inline-flex items-center gap-2 bg-gradient-to-r from-cyan-400 to-blue-600 px-6 py-3 font-mono text-xs font-bold text-black shadow-brutal-sm hover:scale-105 transition-all"
 >
 ...
 {/* Category Filter Bar */}
 <div className="sticky top-20 z-30 mb-12 border border-brand-blue bg-white p-3 -2xl shadow-brutal flex flex-wrap items-center justify-between gap-4">
 ...
 className={` px-4 py-2 font-mono text-xs transition-all duration-300 ${isActive
 ...
 <span className="font-mono text-xs text-brand-blue px-2">EVENTS CALENDAR &apos;26</span>
 </div>
 ...
 <span className=" border border-green-500/30 bg-green-500/10 px-2.5 py-0.5 font-mono text-[10px] text-green-300">
 {event.status}
 </span>
 </div>

 <div className="relative aspect-video w-full overflow-hidden border border-brand-blue">
 <Image
 src={event.img}
 alt={event.title}
 fill
 ...
 <div className="flex items-center justify-between font-mono text-xs text-brand-blue">
 <span>📅 {event.date}</span>
 </div>

 <h3 className="font-display text-xl font-bold text-brand-blue tracking-tight group-hover:text-brand-blue transition-colors">
 {event.title}
 </h3>

 <p className="text-xs font-light text-brand-blue/80/90 leading-relaxed">
 {event.desc}
 </p>
 </div>
 ...
 className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-500 py-3 font-mono text-xs font-bold text-brand-blue shadow-brutal hover:shadow-brutal-sm transition-all"
 >
 ...
 <div className="text-xs text-brand-blue uppercase tracking-widest font-bold">AGENDA &amp; SCHEDULE</div>
 <p className="text-sm font-light text-brand-blue/80 leading-relaxed">
 {activeModalEvent.detailedSchedule}
 </p>
 </div>

 <div className="space-y-3 font-mono">
 <div className="text-xs text-brand-blue uppercase tracking-widest font-bold">PRIZES &amp; PERKS</div>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
 {activeModalEvent.prizesOrPerks.map((perk, idx) => (
 <div key={idx} className="flex items-center gap-2 border border-brand-blue bg-brand-blue/10 p-3 text-xs text-gray-200">
