  ...
  return (
    <main className="relative min-h-screen bg-[#030712] text-white py-20 px-6 lg:px-12 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="sticky top-20 z-30 mb-16 rounded-2xl border border-white/15 bg-[#070F2B]/90 p-3 backdrop-blur-2xl shadow-glass flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/15 bg-white/[0.04] pl-10 pr-4 py-2 font-mono text-xs text-white placeholder-gray-500 outline-none focus:border-cyan-400 focus:bg-black/40 transition-all"
            />
            {searchQuery && (
              <button
        ...
        {selectedCategory === "All" && !searchQuery && (
          <div className="mb-20">
            <div className="mb-4 font-mono text-xs font-bold text-cyan-400 uppercase tracking-widest flex items-center gap-2">
              ...
              <span>FEATURED HIGHLIGHT // PROJECT OF THE MONTH</span>
            </div>

            <div className="relative overflow-hidden rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-white/[0.05] via-white/[0.02] to-transparent p-8 lg:p-12 backdrop-blur-2xl shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7 space-y-6">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 font-mono text-xs text-green-300 flex items-center gap-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-4 border-y border-white/10 py-4 font-mono">
                    {featuredProject.metrics.map((m, i) => (
                      <div key={i} className="space-y-1">
                        <div className="text-xl sm:text-2xl font-bold text-cyan-300">{m.value}</div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-2">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/[0.05] px-6 py-3 font-mono text-xs font-medium text-white hover:bg-white/10 hover:border-cyan-400 transition-all"
                    >
                ...
                <div className="lg:col-span-5 relative h-72 sm:h-96 w-full overflow-hidden rounded-2xl border border-white/15">
                  <Image
        ...
        <div className="space-y-16">
          <div className="flex items-center justify-between border-b border-white/10 pb-4">
            ...
            <span className="font-mono text-xs text-cyan-400">STATUS: ALL SYSTEMS LIVE</span>
          </div>
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-[10px] font-semibold text-cyan-300 uppercase tracking-widest">
                      {project.editionChapter}
                    </span>
                    <span className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-2.5 py-0.5 font-mono text-[10px] text-cyan-300">
                      {project.category}
                    </span>
                  </div>

                  <div className="relative mb-6 h-48 w-full overflow-hidden rounded-2xl border border-white/10">
                    <Image
                      src={project.img}
                      alt={project.title}
                      fill
                  ...
                  <h4 className="font-display text-xl font-bold text-white tracking-tight group-hover:text-cyan-300 transition-colors mb-3">
                    {project.title}
                  </h4>

                  <p className="text-xs font-light text-gray-300/90 leading-relaxed mb-6">
                    {project.desc}
                  </p>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    {project.tags.map((tag, tIdx) => (
                      <span
                        key={tIdx}
                        className="rounded-md border border-white/10 bg-white/[0.04] px-2 py-0.5 font-mono text-[10px] text-gray-300"
                      >
                        #{tag}
                      </span>
                    ))}
            ...
            <div className="relative w-full max-w-3xl overflow-hidden rounded-3xl border border-cyan-500/40 bg-[#030712]/95 text-white shadow-2xl max-h-[90vh] overflow-y-auto scrollbar-thin">
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 space-y-3 font-mono">
                  <div className="text-xs text-cyan-400 uppercase tracking-widest font-bold">SYSTEM METRICS &amp; TELEMETRY</div>
                ...
                <div className="space-y-3">
                  <div className="font-mono text-xs text-gray-400 uppercase tracking-wider">PROJECT LEADERS &amp; ENGINEERS</div>
                  <div className="flex flex-wrap gap-2">
                    {activeModalProject.team.map((member, mIdx) => (
                      <span key={mIdx} className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 font-mono text-xs text-cyan-200">
                        ⚡ {member}
                      </span>
                    ))}
                  </div>
