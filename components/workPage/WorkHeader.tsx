...
const WorkHeader = ({ numBlogs, numProjects }: WorkHeaderProps) => {
 ...
 <div className='flex mt-10 font-light text-brand-blue/80'>
 <div className='pr-4'>
 ...
 <div className='description w-full sm:w-full md:w-4/5 mt-12 text-brand-blue/80 text-md'>
 ...
 <div className='absolute inset-0 -m-2 bg-gradient-to-r from-red-100 to-purple-500 shadow-brutal transform -skew-y-6 sm:skew-y-0 sm:rotate-3 sm:' />
 <div className='relative bg-white shadow-brutal m-1.5 sm:'>
 <div className='flex items-center justify-start pt-6 pl-6'>
 <span className='w-3 h-3 bg-red-400 mr-2' />
 <span className='w-3 h-3 bg-yellow-400 mr-2' />
 <span className='w-3 h-3 bg-green-400 mr-2' />
 </div>
 ...
 <br />
 <span className='text-sm text-brand-blue/80 mb-1 sm:-ml-10'>
 Monthly Stats
 </span>
 ...
 <div className='flex items-center justify-center w-12 h-12 bg-cool-gray-100 text-gray-800 hover:text-gray-900 hover:bg-cool-gray-50 transition duration-300 ease-in-out cursor-pointer'>
 <svg
 className='w-6 h-6'
 fill='none'
 stroke='currentColor'
