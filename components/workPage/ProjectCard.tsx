...
const ProjectCard = (props: { key: string; project: ProjectCardProps }) => {
 ...
 <div className='bg-white shadow-brutal overflow-hidden'>
 <div
 ...
 <div className='p-4'>
 <p className='uppercase tracking-wide leading-relaxed text-xs font-bold text-brand-blue/80'>
 {props.project.type}
 </p>
 <p className='text-2xl leading-relaxed text-gray-900'>
 {props.project.name}
 </p>
 <p className='text-brand-blue/80 leading-relaxed '>{props.project.addr}</p>
 </div>
 <div className='flex p-4 border-t border-brand-blue-300 text-brand-blue/80'>
 ...
 <div className='px-4 pt-3 pb-4 border-t border-brand-blue-300 bg-gray-100'>
 <div className='text-xs uppercase font-bold text-brand-blue/80 tracking-wide'>
 Description:
 </div>
