const Testimonials = () => {
 ...
 <p className='my-6 text-lg text-brand-blue/80'>
 Don&apos;t just take our word for it, read from our extensive
 list of case studies and client feedback.
 </p>
 {/* <a
 href="#_"
 className="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-brand-blue transition duration-150 ease-in-out bg-indigo-600 border border-transparent shadow hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo md:py-4 md:text-lg md:px-10"
 >
 View Case Studies
 </a> */}
 </div>
 <div className='w-full lg:w-1/2'>
 <blockquote className='flex items-center justify-between w-full col-span-1 p-6 my-4 bg-white shadow'>
 ...
 <p className='mt-2 text-sm text-brand-blue/80 sm:text-base lg:text-sm xl:text-base'>
 ...
 Manav
 <span className='mt-1 text-xs sm:text-sm leading-5 text-brand-blue/80 truncate'>
