...
const ContactButtons = ({ links }: ContactButtonProps) => {
 return (
 <section className='text-brand-blue/80 body-font'>
 ...
 <div className='w-16 h-3 bg-indigo-500 inline-flex'></div>
 </div>
 ...
 <div className='border-2 border-brand-blue-200 px-4 py-6 '>
 <svg
 ...
 >
 <button className='ml-auto text-brand-blue bg-primary-default border-0 py-1 mt-2 px-4 focus:outline-none hover:bg-indigo-600 '>
 Instagram
 </button>
 </a>
 </div>
