...
export default function Marquee({ texts, speed = 25 }: MarqueeProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-r from-blue-900/10 via-cyan-900/10 to-blue-900/10 border-y border-white/10 py-6 my-12 backdrop-blur-md">
      <div
      ...
      >
        {repeated.map((text, i) => (
          <div key={i} className="flex items-center gap-16">
            <span className="font-display text-4xl sm:text-5xl tracking-widest text-white uppercase font-black">
              {text}
            </span>
