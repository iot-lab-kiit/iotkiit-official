...
const EventListItemCenter = ({ point, ...rest }: { point: any; [key: string]: any }) => {
 ...
 <span className="text-brand-blue/80 text-lg ml-3">{point}</span>
 </li>
 );
};
...
const FlagshipEvents = ({ main, left, right }: { main: any; left: any; right: any }) => {
 ...
 <p className="text-center text-lg text-brand-blue/80 mt-2 px-6"></p>
 <div className="h-1 mx-auto bg-indigo-200 w-24 opacity-75 mt-4 "></div>

 <div className="max-w-full md:max-w-6xl mx-auto my-3 md:px-8">
 <div className="relative flex flex-col md:flex-row items-center">
 <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 shadow-brutal md:-mr-4">
 <div className="bg-white text-black shadow-inner overflow-hidden">
 <div className="text-sm object-center leading-none -lg bg-white-200 text-black font-semibold uppercase pt-6 text-center tracking-wide">
 <img
 ...
 <h2 className="text-sm tracking-widest font-medium pt-1 text-brand-blue/80 text-center pb-5">
 {left.date}
 </h2>
 {left.desc}
 </div>
 ...
 <div className="w-full max-w-md sm:w-2/3 lg:w-2/5 sm:my-5 my-8 relative z-10 shadow-brutal ">
 <div className="bg-white text-black shadow-inner overflow-hidden">
 <div className="text-sm object-center leading-none -lg bg-white-200 text-black font-semibold uppercase pt-3 text-center tracking-wide">
 <img
 ...
 <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 shadow-brutal md:-ml-4">
 <div className="bg-white text-black shadow-inner overflow-hidden">
 <div className="text-sm object-center leading-none -lg bg-white-200 text-black font-semibold uppercase pt-6 text-center tracking-wide">
 <img
 className="w-auto h-16 inline-block"
