...
const EventCard = (props: any) => {
 return (
 <div className="lg:w-3/12 md:w-3/12 min-w-max sm:w-full h-1/2 shadow-brutal ">
 ...
 <p className="text-3xl mb-3 text-brand-blue/80">per year</p>
 </div>
 ...
 <button className="place-self-center font-semibold p-4 text-brand-blue bg-main-btn-color focus:outline-none hover:bg-brand-blue/10">
 GET STARTED
 </button>
 </div>
