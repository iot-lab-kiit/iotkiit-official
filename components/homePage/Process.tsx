...
export default function Process() {
 ...
 <div className="pointer-events-none absolute top-1/2 left-10 -translate-y-1/2 h-[450px] w-[450px] bg-brand-blue/10 blur-[150px]" />
 ...
 <div
 key={idx}
 className="group relative overflow-hidden border border-brand-blue bg-brand-blue/10 p-8 -2xl shadow-brutal transition-all duration-500 hover:border-brand-blue-400/40 hover:bg-brand-blue/10 hover:-translate-y-2"
 >
 <span className="font-mono text-5xl font-extrabold text-brand-blue/10 group-hover:text-brand-blue/20 transition-colors block mb-4">
 {step.num}
 </span>

 <div className="space-y-3">
 <div className="flex items-center gap-3">
 <div className="flex h-10 w-10 items-center justify-center bg-brand-blue/10 text-brand-blue group-hover:bg-brand-blue/10 group-hover:text-brand-blue transition-colors duration-300">
 <Icon className="h-5 w-5" />
 </div>
 <h3 className="text-xl font-bold text-brand-blue group-hover:text-brand-blue transition-colors">
 {step.title}
 </h3>
 </div>
