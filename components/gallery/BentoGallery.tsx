...
function ImageTile({
 ...
 return (
 <div
 className={`group relative animate-tile-in overflow-hidden ring-1 ring-white/10 shadow-brutal transition-all duration-300 hover:-translate-y-1 hover:shadow-brutal hover:ring-[#8B9FDE]/40 ${className}`}
