...
const FormComponent: React.FC = () => {
 ...
 <div className='relative flex flex-col min-w-0 break-words w-full mb-6 shadow-brutal bg-blueGray-200'>
 ...
 className='bg-gray-800 text-brand-blue active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 shadow hover:shadow-brutal outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
 type='button'
 >
 Register
 </button>
