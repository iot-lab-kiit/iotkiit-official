...
const HeroComponent: React.FC = () => {
 ...
 <p className='text-lg leading-relaxed mt-4 mb-4 text-brand-blue/80'>
 ...
 <div className='text-lightBlue-300 p-3 w-12 h-12 shadow-brutal bg-white inline-flex items-center justify-center'>
 ...
 <div className='w-full lg:w-3/12 px-4 text-center'>
 <div className='text-blueGray-800 p-3 w-12 h-12 shadow-brutal bg-white inline-flex items-center justify-center'>
